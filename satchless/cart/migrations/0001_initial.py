...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cart_cart', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='carts', null=True, to=orm['auth.User'])),
            ('typ', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.create_table('cart_cartitem', (
            ...
            ('variant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['product.Variant'])),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=4)),
        ))
        db.send_create_signal('cart', ['CartItem'])

        # Adding unique constraint on 'CartItem', fields ['cart', 'variant']
        db.create_unique('cart_cartitem', ['cart_id', 'variant_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CartItem', fields ['cart', 'variant']
        db.delete_unique('cart_cartitem', ['cart_id', 'variant_id'])
    ...
    models = {
        ...
        'cart.cartitem': {
            'Meta': {'unique_together': "(('cart', 'variant'),)", 'object_name': 'CartItem'},
            ...
            'variant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['product.Variant']"})
        },
