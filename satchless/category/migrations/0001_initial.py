...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('category_category_products', (
        ...
        db.create_unique('category_category_products', ['category_id', 'product_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('category_category_products')
    ...
    models = {
        'category.category': {
            ...
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'categories'", 'blank': 'True', 'to': "orm['product.Product']"}),
