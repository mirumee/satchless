...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DjangoPaymentsVariant'
        db.create_table('django_payments_provider_djangopaymentsvariant', (
            ...
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(related_name='satchless_payment_variant', unique=True, to=orm['payments.Payment'])),
        ))
        db.send_create_signal('django_payments_provider', ['DjangoPaymentsVariant'])


    def backwards(self, orm):
        
        # Deleting model 'DjangoPaymentsVariant'
        db.delete_table('django_payments_provider_djangopaymentsvariant')
    ...
    models = {
        ...
        'django_payments_provider.djangopaymentsvariant': {
            'Meta': {'object_name': 'DjangoPaymentsVariant', '_ormbases': ['payment.PaymentVariant']},
            'payment': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'satchless_payment_variant'", 'unique': 'True', 'to': "orm['payments.Payment']"}),
    ...
    complete_apps = ['django_payments_provider']
