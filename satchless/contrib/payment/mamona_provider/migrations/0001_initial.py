...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MamonaPaymentVariant'
        db.create_table('mamona_provider_mamonapaymentvariant', (
        ...
        db.send_create_signal('mamona_provider', ['MamonaPaymentVariant'])


    def backwards(self, orm):
        
        # Deleting model 'MamonaPaymentVariant'
        db.delete_table('mamona_provider_mamonapaymentvariant')
    ...
    models = {
        ...
        'mamona_provider.mamonapaymentvariant': {
            'Meta': {'object_name': 'MamonaPaymentVariant', '_ormbases': ['payment.PaymentVariant']},
